      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="(scope.row.statusId == 1) || (scope.row.statusId == 2)" style="padding: 3px;" size="mini" @click="ratify(scope.row)">批准</el-button>
...
export default {
  ...
  methods: {
    ratify(scope) {
      console.log(scope)
      this.getRequest('/operation-info/ratify/?id=' + scope.id + '&statusId=' + scope.statusId).then(resp => {
        if (resp) {
