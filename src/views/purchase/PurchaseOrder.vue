  ...
  <div>
    <div style="display: flex;justify-content: space-between">
      ...
      <div>
        ...
        <el-button type="primary" icon="el-icon-plus" @click="showAddPurchase">添加采购订单</el-button>
      </div>
    </div>
    <div>
      <el-table
...
export default {
  ...
  methods: {
    initPruchaseOrder() {
      this.getRequest('/operation-info/getAllOperation/?currentPage=' + this.currentPage + '&size=' + this.size).then(resp => {
        if (resp) {
          console.log(resp)
    ...
    addOperation() {
      ...
      this.postRequest('/operation-info/addOperation', this.purchase).then(resp => {
      })
    },
    addMete() {
